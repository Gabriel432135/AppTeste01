...
public class TelaLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.button.setOnClickListener(view1 -> {
            try {
                loginUsuarioSenha(binding.editTextTextUsuRio.getText().toString(), binding.editTextTextPassword.getText().toString());
            }catch (Exception e){
    ...
    public void loginUsuarioSenha(String usuario, String senha){
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            // If sign in fails, display a message to the user.
                            Toast.makeText(getApplicationContext(), "Falha ao realizar login: "+task.getException(), Toast.LENGTH_LONG).show();
                            //updateUI(null);
                        }
